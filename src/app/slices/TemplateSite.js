    ...
    <>
      <section className="bg-black text-white mt-[5rem] items-center p-6 gap-8 flex text-center flex-col min-h-[100dvh]">
        ...
        <div className="flex flex-col gap-2">
          ...
          >
            <Image
              src={siteDescriptions[0].thumbnail}
              alt="flex"
              fill
        ...
        <a href="https://wingland-revitalized.vercel.app">
          <button className="border w-[10rem] bg-[#30ffffaf] hover:bg-black active:bg-[#27cccc] active:scale-[0.97] transition-all duration-150 p-2 rounded-md">
            View
          </button>
        </a>
        ...
        <div className="flex flex-col gap-2">
          ...
          >
            <Image
              src={siteDescriptions[1].thumbnail}
              alt="flex"
              fill
              className="object-cover"
            />
        ...
        <div className="flex flex-col mt-[5rem]">
          <span>
            Our templates are intentionally minimal — serving as a clean
            foundation and a glimpse into the possibilities of what we can
            create together.
          </span>
          <span>
            Inspired by one of our templates? Let’s bring your vision to life —
