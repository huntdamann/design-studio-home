...
function FooterSection({ workHandle, whoHandle  }) {
  return (
    <footer className="w-full bg-black text-white px-6 py-12 lg:py-16">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-between gap-12">
        ...
        <div className="flex-1">
          ...
          <ul className="space-y-3 text-sm uppercase text-gray-300">
                ...
                <li onClick={workHandle} className="transition-colors duration-200 hover:text-[#72d0c8] active:text-[#72d0c8] cursor-pointer">
                    <span>Our Work</span>
                </li>
                <li className="transition-colors duration-200 hover:text-[#72d0c8] active:text-[#72d0c8] cursor-pointer">
                ...
                <li onClick={whoHandle} className="transition-colors duration-200 hover:text-[#72d0c8] active:text-[#72d0c8] cursor-pointer">
                    <span>Company</span>
                </li>
                <li className="transition-colors duration-200 hover:text-[#72d0c8] active:text-[#72d0c8] cursor-pointer">
