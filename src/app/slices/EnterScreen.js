...
const EnterScreen = forwardRef( ({ onFinish }, ref) =>  { 
    ...
    return (
        ...
        <section ref={ref} id="prescreen" className="w-screen h-screen fixed z-[1000]">
            ...
            <CardBody className="bg-transparent flex flex-col items-center relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] border-green-50/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 ">
                <CardItem
                translateZ="50"
